  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="/" class="logo">
        ...
        <span class="logo-lg"><b>Smart</b></span>
      </a>
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="###" class="dropdown-toggle" data-toggle="dropdown" v-on:click="changeUserName">
                <img src="static/avatar.png" class="user-image" alt="User Image">
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; {{year}}
        <a href="javascript:;">AdminLTE</a>.</strong> All rights reserved.
    </footer>
  </div>
  <!-- ./wrapper -->
</template>
